...
x_train = []
with io.open('/u/eot/syf1219/scratch/preprocessed_data/imdb_train.txt','r',encoding='utf-8') as f:
    lines = f.readlines()
for line in lines:
    line = line.strip()
    line = line.split(' ')
...
if(opt=='adam'):
    ...
    optimizer = optim.SGD(params, lr=LR, momentum=0.9, weight_decay=1e-5)
